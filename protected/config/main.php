...
$patern.="|monerisinit|confirmorder|rzrinit|rzrverify|acceptorder|declineorder|cart|restaurant|vntinit";
...
return array(
	...
	'components'=>array(		   
		...
		'db'=>array(	        
		    'class'            => 'CDbConnection' ,
			'connectionString' => 'mysql:host=localhost;dbname=c41673takeoutlist',
			'emulatePrepare'   => true,
			'username'         => 'c41673takeout',
			'password'         => '0utw0w7wl85f',
			'charset'          => 'utf8',
			'tablePrefix'      => 'mt_',
	    ),
