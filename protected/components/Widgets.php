		...
		if (isset($_SESSION['search_type'])){
			switch ($_SESSION['search_type']) {
				...
				case "kr_search_restaurantname":
					$search_str="restaurant-name1=".urlencode($_SESSION['kr_search_restaurantname']);
					break;	
...
public function featuredMerch()
	{
		if ($rres=Yii::app()->functions->getFeatureMerch()):				   
		?>
		<div class="featured-restauranst" id="featurrestaurant-list">
          <div class="main">          
           <h2><?php echo t("Featured Restaurants")?></h2>
           <div class="feature-merch-loader"><i class="fa fa-spinner fa-spin"></i></div>
           
           <div class="bxsler-1">
           <ul class="bxsder"> 
           <?php foreach ($rres as $val):?>
           <?php            
           $cat_logo=$val['cat_logo'];
           if (empty($cat_logo)){
           	   $cat_logo=assetsURL()."/images/thumbnail-mini.png";
           } else $cat_logo=uploadURL()."/$cat_logo";
           ?>
           ...
           <li>
           <a href="<?php echo baseUrl()."/store/menu/merchant/".$val['restaurant_slug']?>">
           <img src="<?php echo $cat_logo?>" alt="<?php echo $val['restaurant_name']?>" />
           <p><?php echo $val['restaurant_name']?></p>
           </a>
           </li>           
           <?php endforeach;?>
           ...
           <?php foreach ($res as $val):?>
           <?php            
           $cat_logo=$val['merchant_logo'];
           if (empty($cat_logo)){
           	   $cat_logo=assetsURL()."/images/thumbnail-mini.png";
           } else $cat_logo=uploadURL()."/$merchant_logo";
           ?>
           <li>
           <a href="<?php echo baseUrl()."/store/menu/merchant/".$val['restaurant_slug']?>">
           <img src="<?php echo $cat_logo?>" alt="<?php echo $val['restaurant_name']?>" />
