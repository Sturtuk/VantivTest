...
{	
	...
	public function merchantMenu()
	{
		...
		$payment_list=array('visible'=>$this->hasMerchantAccess("payment-gateway"),'tag'=>'payment-gateway','label'=>'<i class="fa fa-usd"></i>'.Yii::t("default",'Payment Gateway'),
                   ...
                   array('visible'=>$this->hasMerchantAccess("vnt"),'tag'=>'paypal', 'label'=>'<i class="fa fa-paypal"></i>'.Yii::t("default","Paypal"),                    
	...
	public function hasMerchantAccess($tag='')
	{
		...
		/*$tag_paymentgateway=array(
		  ...
		  'atz','obd','vnt','stp','mcd','ocr','btr','rzr','mri'
		);				
		...
		return array(  
		    ...
		    'items'=>array(
                ...
                'label'=>'<i class="fa fa-usd"></i>'.Yii::t("default",'Payment Gateway'),
                   ...
                   'tag'=>'paypalSettings','label'=>'<i class="fa fa-paypal"></i>'.Yii::t("default","Vantiv Payment Gateway"), 
...
$menu_html.="</li>";
    ...
    public function adminPaymentList()
    {
    	...
    	<?php if ( $admin_enabled_paypal==""):?>
         ...
         array('class'=>"icheck payment_option",'value'=>"vnt"))?> <?php echo Yii::t("default","Paypal")?>
         </div>   
         <?php endif;?>
         ...
         <div class="uk-form-row">
         <?php echo CHtml::radioButton('payment_opt',false,
         array('class'=>"icheck payment_option",'value'=>"ide"))?> <?php echo Yii::t("default","Hello")?>
         </div>     
         <?php endif;?>         
