...
<div class="container">
  ...
  <div class="row">
     <!--LEFT CONTENT-->
	  <div class="col-md-6 border cout_input" >
	   ...
	   <div class="box-grey rounded">      
		 ...
		 <?php if ($captcha_customer_login==2):?>
		  ...
		  <div class="row top15">	
		   ...
		   <div class="col-md-6 cout-log">
		     <input type="submit" value="<?php echo t("Login")?>" class="cout-login">
		   </div>
		  </div>
		  		</div>  
		</form>  		  		
	  ...
	  <div class="col-md-6 border" >
	    ...
	    <form id="form-signup" class="form-signup uk-panel uk-panel-box uk-form cout_input" method="POST">
